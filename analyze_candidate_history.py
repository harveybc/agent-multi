...
With --fetch: pulls CSVs from dragon (192.0.2.14) and gamma (192.0.2.13)
...
NODES = {
    ...
    "dragon": {"host": "192.0.2.14", "csv": ANALYSIS_DIR / "dragon_history.csv"},
    "gamma": {"host": "192.0.2.13", "csv": ANALYSIS_DIR / "gamma_history.csv"},
}
...
def fetch_remote_csvs():
    ...
    for name, info in NODES.items():
        ...
        try:
            r = subprocess.run(
                ["scp", "-P", "22022", "-o", "ConnectTimeout=10", src, str(dest)],
