...
import os
REPO = Path(os.path.expanduser("~/Documents/GitHub/.worktrees/am-data-first"))
...
def probe(tag, mutate):
    ...
    mutate(b)
    # a coherent forger updates the code identity too — this
    # isolates the SEMANTIC layer as the order demands
