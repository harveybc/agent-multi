...
| AUD-F1-20260817-278 | S2 | open; independently reproduced | Policy classifier drops malformed/non-finite actions and counts exact zero as a threshold-zero crossing | General Satoshi corrects strict cardinality/finite semantics and crossing logic; independent verifier reruns adversarial fixture |
| AUD-F1-20260817-279 | S2 | open; independently reproduced | Policy sidecar bypasses role boundaries and lacks per-measurement trace/model/config custody binding | General Satoshi resolves manifest roles, stable snapshots and complete custody; independent verifier attacks sealed/outer boundaries |
...
| AUD-F1-20260817-281 | S2 | open; independently reproduced | Action variation is labeled state-responsive/promotable without any paired observation evidence | General Satoshi separates mapped activity from observation-conditioned behavior and adds bound real-observation controls |
