...
account fingerprint 0123456789abcdef (DU prefix, paper)
...
(`0123456789abcdef`) DIFFERS from the one in the 2026-08-02 capability
evidence (`9f9f5111f7b27a78`). Both are DU paper accounts; the difference
...
| Account fingerprint | `0123456789abcdef` (bound; mismatch refuses) |
