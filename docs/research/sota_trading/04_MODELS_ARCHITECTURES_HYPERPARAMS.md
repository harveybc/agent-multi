...
- **Redes (pirámide geométrica)**: NN1=32; NN2=32,16; NN3=32,16,8;
  ...
  batch-norm tras cada ReLU. Fuente: [GKX2020 loc:§1.3-1.7], [GKX2020-IA loc:Tab.A.5]
- **Entrenamiento NN (Internet Appendix Tabla A.5, exacto)**: L1
  λ1∈(1e-5,1e-3); Adam LR∈{0.001,0.01}; batch 10.000; 100 épocas;
  early-stop paciencia 5; **ensemble de 10 semillas promediado**. Fuente: [GKX2020 loc:§1.3-1.7], [GKX2020-IA loc:Tab.A.5]
- RF: 300 árboles, profundidad 1–6, features/split
  ∈{3,5,10,20,30,50}; GBRT: profundidad 1–2, 1–1000 árboles,
  LR∈{0.01,0.1}; ENet ρ=0,5; Huber ξ = cuantil 99,9%. Fuente: [GKX2020 loc:§1.3-1.7], [GKX2020-IA loc:Tab.A.5]
...
- **LSTM**: 1 capa, 25 neuronas ocultas, dropout recurrente 0,1 (Gal
  & Ghahramani), densa 2 + softmax. **2.752 parámetros LSTM**. Fuente: [FK2018 loc:§3.3-3.4]
- Entrenamiento: cross-entropy, RMSprop, early stopping (máx 1.000
  épocas, paciencia 10, restaura mejores pesos). Keras/TensorFlow.
  [Batch size NO DECLARADO]. Fuente: [FK2018 loc:§3.3-3.4]
...
- **Arquitectura común**: LSTM 2 capas 64→32, Leaky-ReLU — idéntica
  para Q-network, políticas, actor y crítico. Fuente: [ZZR2020 loc:Tab.1,§4]
- **Algoritmos**: DQN (con target fijo, Double, Dueling); Policy
  Gradient vanilla; A2C síncrono. Acciones: {−1,0,1} discreto
  (DQN/PG); [−1,1] continuo (A2C). Fuente: [ZZR2020 loc:Tab.1,§4]
- **Hiperparámetros (Tabla 1)**: DQN — LR crítico 1e-4, Adam, batch
  ...
  actor 1e-4, batch 128, γ=0,3. [Épocas NO DECLARADAS]. Fuente: [ZZR2020 loc:Tab.1,§4]
...
- **LSTM 64 unidades** → softmax 3 clases. **~60.000 parámetros**
  (vs 768k del CNN-I baseline). Fuente: [DEEPLOB2019 loc:§IV arquitectura]
- Entrenamiento: ADAM **LR 0,01, epsilon 1**, batch 32,
  cross-entropy categórica, early-stop cuando validación estanca 20
  épocas (~100 épocas FI-2010, ~40 LSE). Fuente: [DEEPLOB2019 loc:§IV arquitectura]
...
- Salida: posición z∈(−1,1) por activo/día; pérdida = −Sharpe
  anualizado; mini-batch SGD. Fuente: [WOOD2022 loc:§III-IV]
...
- **Deng FDDR**: fuzzy(R^150) → 4 capas sigmoides 128-128-128-20 →
  ...
  DECLARADO numéricamente]. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
- **Jiang EIIE**: evaluadores idénticos independientes con pesos
  ...
  — UNVERIFIED en el paper]. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
...
- **TLOB**: bloque dual — atención temporal + atención sobre features
  ...
  Adam. [Parámetros totales/batch/épocas NO DECLARADOS]. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
- **Sirignano-Cont**: 3 capas LSTM + 1 feed-forward ReLU, 50
  ...
  DECLARADOS]. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
...
- **Hiperparámetros de campaña (materializados en manifiestos de
  ...
  SB3-compatibles declarados en `sac_agent.plugin_params`]. Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
- **Extractor agrupado (rama experimental separada, NO en P1)**:
  ...
  gradientes, refusal de orden de columnas); §2–§6 en curso. Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
