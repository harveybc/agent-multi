...
- **R² OOS mensual por acción** (vs pronóstico cero, %): OLS-920
  **−3,46**; OLS-3+H 0,16; PLS 0,27; PCR 0,26; ENet+H 0,11; GLM+H
  ...
  0,67. S&P 500 mensual: NN3 1,80%. Fuente: [GKX2020 loc:Tab.1]
- **Deciles long-short** (mensual medio / σ / Sharpe anualizado):
  ...
  **Sharpe 2,45** (1,69 excluyendo micro-caps bajo el percentil 20
  NYSE). Fuente: [GKX2020 loc:Tab.5], [GKX2020 loc:Tab.7]
- **Alphas** (FF5+momentum): VW NN4 1,76%/mes (t=6,00, IR 1,18); EW
  3,08%/mes (IR 2,40). MDD NN4: 51,8% VW / 14,7% EW; peor mes −9,01%
  (EW). Turnover 110–130%/mes. **Costes NO deducidos.** Fuente: [GKX2020 loc:Tab.8]
...
- **Retorno diario ANTES de costes**: LSTM 0,46%; RF 0,43%; DNN
  ...
  RF 5,00; DNN 2,43; LOG 1,70. Fuente: [FK2018 loc:Fig.3,Tab.3,§4.1.4]
- **DESPUÉS de costes (5 pb/media vuelta)**: LSTM **0,26%/día**
  ...
  MDD neto LSTM: 52,33% (el menor). Fuente: [FK2018 loc:Fig.3,Tab.3,§4.1.4]
- Accuracy: LSTM 54,3% / RF 53,8% / DNN 53,7% / LOG 52,2%;
  Diebold-Mariano: LSTM superior (p=0,0143 vs RF; 0,0037 vs DNN). Fuente: [FK2018 loc:Fig.3,Tab.3,§4.1.4]
...
- **Portafolio 50 contratos** (E(R) anualizada / Sharpe): DQN
  ...
  momentum-1a 0,429/0,441, MACD 0,089/0,091. Fuente: [ZZR2020 loc:Tab.2,Tab.3,Fig.2]
...
- **Robustez a costes**: DQN y A2C rentables hasta ~25 pb (~$3,5 por
  contrato); baselines colapsan mucho antes. Win rate 0,49–0,54. Fuente: [ZZR2020 loc:Tab.2,Tab.3,Fig.2]
- Nota: MDD (0,002–0,066) es de retornos vol-targeted; el σ objetivo
  numérico NO está declarado. Fuente: [ZZR2020 loc:Tab.2,Tab.3,Fig.2]
...
- **LSE out-of-sample** (acc/F1): k=20 70,17/70,15; k=50 63,93/63,49;
  ...
  universalidad). Fuente: [DEEPLOB2019 loc:tablas setup1/setup2,§V LSE]
...
- **Deng FDDR** (IF, objetivo TP; beneficio total en puntos / SR%):
  ...
  ~2.800 trades. Win rate ≈0,51–0,53. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
- **Jiang EIIE** (con 0,25% comisión; fAPV = múltiplo final en ~51
  días): BT1 CNN **29,7×** (SR/30min 0,087; MDD 0,224); BT2 8,0×;
  BT3 bRNN **47,1×**/CNN 31,7×; mejor no-DL (RMR) 7,0×. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
- **Kronos**: RankIC 0,0345 (vs 0,0179 mejor TSFM); IC retorno
  ...
  UNVERIFIED]. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
- **FinAgent** (jun 2023–ene 2024; ARR%/Sharpe/MDD%): TSLA
  **92,27/2,01/12,14**; GOOGL 56,15/1,78/8,45; ETHUSD
  ...
  39,0→57,2→89,3→92,3%. Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
...
- **Sirignano-Cont**: modelo universal > modelos por-acción en 25/25
  ...
  acciones (+7,2/+3,7/+1,6%). Fuente: [DENG2017 loc:Tab.I-III,Fig.7], [JIANG2017 loc:Tab.1-2,§5], [KRONOS2025 loc:§4,Fig.4], [FINAGENT2024 loc:Tab.4,§5], [FINMEM2023 loc:§4,Tab.resultados], [TLOB2025 loc:Tab.8,§5], [SIRCONT2019 loc:Tab.1,§3-4], [LOBCAST2024 loc:benchmark propio], [STOCKBENCH2025 loc:benchmark propio]
...
- **Métricas de selección (nunca de reporte final)**: composite del
  ...
  actividad episódica (sentinela −100 solo a episodios sin trades). Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
- **Métrica de decisión (endpoint)**: UNA evaluación post-selección
  ...
  Sharpe, trades, exposición, diversidad de acción. Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
- **Reglas pre-declaradas**: dirección FOR/AGAINST exige ≥3/4
  ...
  `treatment_divergence` obligatorio (easy inerte ⇒ uninformative). Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
- **Resultados**: campaña P1 4×3 EN CURSO (sin veredicto; primeros
  ...
  SIGNAL_AGAINST (temprano) — spec rechazada como gen DOIN. Fuente: [OURS-PIPELINE loc:configs+manifiestos verificados por ejecución]
