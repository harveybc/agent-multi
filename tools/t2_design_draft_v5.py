#!/usr/bin/env python3
"""T2-S step 6 (order C31-C36): DRAFT v5 — the FINAL screen design
under the COMMON TWO-ORIGIN geometry. Supersedes v4 by digest; v2,
v3 and v4 stay on disk as immutable history.
...
def main() -> int:
    ...
    draft = {
        "schema": "agent_multi.t2_screen_design.v5_draft",
